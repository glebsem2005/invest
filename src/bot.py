...
"""
        ...
        self.qa_integration_prompt = """
Ты помощник для добавления Q&A в инвестиционный отчет.

Задача: добавь к существующему отчету раздел с дополнительными вопросами и ответами.

Правила:
1. Сохрани весь оригинальный отчет без изменений
2. В конце добавь новый раздел "Дополнительные вопросы и ответы"
3. Оформи каждый вопрос как подзаголовок, а ответ как текст под ним
4. Сохрани профессиональный стиль
